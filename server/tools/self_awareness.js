...
function parseSkillMeta(skillPath, folderName) {
  ...
  if (fs.existsSync(jsonPath)) {
    try {
      ...
      console.error(`[SelfAwareness] Failed to parse skill.json at ${jsonPath}:`, err.message);
    }
  }
  ...
  if (fs.existsSync(mdPath)) {
    try {
      ...
      console.error(`[SelfAwareness] Failed to parse SKILL.md at ${mdPath}:`, err.message);
    }
  }
  ...
  try {
    ...
    console.error(`[SelfAwareness] Failed to read dir ${skillPath}:`, err.message);
  }
